...
# bart_model.load_state_dict(torch.load('"E:\\DL Project\\bart.h5"', map_location=torch.device('cpu')))
...
bart_model_2.load_state_dict(torch.load("C:\\Users\\nayin\\Downloads\\Bart_model_gsd.h5", map_location=torch.device('cpu')))
